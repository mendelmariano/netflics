...
class LoginRepository @Inject constructor(
    ...
    private fun parseResultError(e: Throwable?): AppResult.Error {
        return when(e){
            is FirebaseAuthInvalidCredentialsException -> AppResult.Error(context.getString(R.string.login_invalid_credencials), e)
            is FirebaseAuthInvalidUserException -> {
                val msg = when (e.errorCode) {
                    ...
                    else-> context.getString(R.string.login_invalid_credencials)
                }
