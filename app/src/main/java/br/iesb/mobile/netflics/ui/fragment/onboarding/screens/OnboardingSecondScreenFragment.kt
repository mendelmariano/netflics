 ...
 * Use the [OnboardingSecondScreenFragment.newInstance] factory method to
...
class OnboardingSecondScreenFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OnboardingSecondScreenFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                OnboardingSecondScreenFragment().apply {
